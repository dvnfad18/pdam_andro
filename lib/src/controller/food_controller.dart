...
//   RxList<Food> filteredFoods = AppData.data.obs;
...
//
//     if (category.kategori == FoodType.Semua) {
//       filteredFoods.assignAll(AppData.data.obs);
//     } else {
//       filteredFoods.assignAll(AppData.data.where((item) {
//         return item.kategori == category.kategori;
//       }).toList());
//     }
//     update();
//
